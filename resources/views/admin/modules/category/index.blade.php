                        ...
                        <table id="basic-datatables" class="display table table-striped table-hover">
                            ...
                            <tbody>
                                ...
                                <tr id="row_{{ $category->id }}">
                                    ...
                                    <td>
                                        {{ $category->created_at != $category->updated_at ? $category->updated_at->format('d-m-Y') : "Not Updated" }}
                                    </td>
                                    <td>
                                        ...
                                        <form action="{{ route('category.destroy', $category->id) }}" method="POST" class="delete-form" id="form_{{ $category->id }}" style="display: inline;">
                                            @csrf
                                            @method('DELETE')
