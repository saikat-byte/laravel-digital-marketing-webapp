            ...
            <div class="row d-flex justify-content-center align-items-center">
                ...
                <div class="col-lg-4 mb-5 mb-lg-0 left-col d-flex flex-column justify-content-center">
                    ...
                    <div class="form-wrapper p-4">
                        <h5 class="mb-4 text-uppercase">{{ $section->heading }}</h5>
                        <h2 class="mb-4 text-uppercase">{{ $section->sub_heading }}</h2>
                        <!-- Contact Form -->
                ...
                <div class="col-lg-6 right-col d-flex flex-column justify-content-center p-4">
                    ...
                    <div class="row">
                        <div class="col-lg-12 mt-2">
                            <div class="mapouter">
                                <div class="gmap_canvas"><iframe class="gmap_iframe" width="100%" frameborder="0" scrolling="no" marginheight="0" marginwidth="0" src="https://maps.google.com/maps?width=800&amp;height=200&amp;hl=en&amp;q=130, Feeder Rd, Verner Lane, Belghoria, Kolkata, West Bengal 700056&amp;t=k&amp;z=14&amp;ie=UTF8&amp;iwloc=B&amp;output=embed"></iframe><a href="https://sprunkiphasez.com/">Sprunki Phase</a></div>
                                <style>
                                    .mapouter {
                                        position: relative;
                                        text-align: right;
